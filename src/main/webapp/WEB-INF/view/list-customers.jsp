                    ...
                    <tr>
                        ...
                        <td class="col-md-2">
                            <div class="col-md d-flex justify-content-center">
                                ...
                                <button type="button" class="btn btn-outline-danger deleteCustomerBtn p-2" data-bs-toggle="modal" data-bs-target="#delete-customer-modal">
...
<jsp:include page="delete-customer-modal.jsp"/>
